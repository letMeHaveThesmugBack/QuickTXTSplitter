    ...
    internal static partial class FileSplitter
    {
        ...
        internal static void Split(string sourceFilepath, ArgParser.ParsedArgs args)
        {
            try
            {
                ...
                {
                    operationBuilder.Clear().Append("split ").Append(sourceFilepath).Append("at line \"").Append(line).Append('"');
            ...
            {
                WriteStandardizedErrorMessageAndExit(operationBuilder.ToString(), ex);
            }
        }
